...
def help_msg(message):
    bot.send_message(message.from_user.id, "Бот понимает такие команды как:"
                                           "/start - начать работу"
                                           "/help - узнать список команд"
                                           "/tts - перевести текст в голосовое сообщение"
                                           "/stt - перевести голосовое сообщение в обычное")
